...
- [Proxmox LXC (unofficial)]([https://github.com/community-scripts/ProxmoxVED/issues/216](https://github.com/community-scripts/ProxmoxVED/issues/216)) - appsettings.json muss nach Installation konfiguriert werden
